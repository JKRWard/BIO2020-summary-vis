...
This tutorial focuses more on the 'how', offering you some code chunks that you can modify (and reuse in future should you need to)to help you familiarise yourself with carrying out such operations in R, the 'why' pertaining to many of the concepts touched on here will be covered in more detail in the Summary Stats tutorial.

## Checking your data 

Once you have collected your data and read it in to R (if you need a recap of reading in data go to bact to the previous tutorial) the first thing to do is to check that you have the right data!
...
You have now succesfully created some informative plots that you could put striaght into a report about penguins such as the [Paper](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0090081) that these data were origionally published in.
